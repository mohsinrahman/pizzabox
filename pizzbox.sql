...
--
-- Host: localhost:3307
-- Generation Time: Feb 10, 2020 at 01:20 PM
...
(1, 'California', 'It is made with mustard, ricotta, pate, and red pepper', 120, 'PizzaMenu', 100),
(2, 'Detroit', 'Detroit pizza is first topped with pepperoni, followed by brick cheese which is spread to the very edges of the pan, yielding a caramelized cheese perimeter.', 80, 'PizzaMenu', 100),
(3, 'Sicilian Pizza', 'It is a cut of pizza with pillowy dough, a crunchy crust, and robust tomato sauce.', 90, 'MainMenu', 100);
